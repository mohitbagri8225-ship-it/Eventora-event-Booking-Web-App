            ...
            <div style="font-family:Arial,Helvetica,sans-serif;background:#f4f6f8;padding:20px;">
                <div style="max-width:420px;margin:auto;background:#fff;border-radius:10px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.08);">
                    ...
                    <div style="padding:24px;text-align:center;">
                        <p style="color:#666;font-size:14px;margin:0 0 12px;">Use the code below to verify your <strong>${type}</strong>:</p>
                        <div style="display:inline-block;padding:10px 22px;background:#f3f4f6;border:2px dashed #4f46e5;border-radius:8px;font-size:26px;font-weight:bold;letter-spacing:6px;color:#111;">${otp}</div>
                        <p style="color:#dc2626;font-weight:bold;font-size:13px;margin:14px 0 4px;">Expires in 5 minutes</p>
                        <p style="color:#888;font-size:12px;margin:8px 0 0;">Didn't request this? You can ignore this email.</p>
                    </div>
